...
#reserveManager #addAndSearch {
  padding: 20px;
  width: 100%;
  height: 50px;
}
#reserveManager #addAndSearch .el-input {
  width: 200px;
}
#reserveManager #addAndSearch #add {
  float: left;
}
#reserveManager #addAndSearch #search {
  float: right;
  margin-right: 60px;
}
#reserveManager #addAndSearch #search .el-input {
  width: 120px;
}
#reserveManager #editDialog .el-input {
  width: 280px;
}
#reserveManager #page {
  bottom: 0;
...
#reserveManager #formDiv .el-table th,#reserveManager #formDiv .el-table tr,#reserveManager #formDiv .el-table__empty-block,#reserveManager .el-table__row td
{
